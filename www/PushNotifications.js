...
PushNotification.prototype.init = function(options)
{
    ...
    exec(this._success, this._fail, 'PushNotification', 'init', [options]);
};
/**
...
PushNotification.prototype.on = function(eventName, callback)
{
    ...
    var handleIndex = this._handlers[eventName].indexOf(callback);
    if (handleIndex === -1)
    {
...
PushNotification.prototype.getDeviceToken = function(successCallback, errorCallback)
{
    ...
    if (typeof errorCallback !== 'function')
    {
        console.log('PushNotification.getDeviceToken failure: failure parameter not a function');
        return;
    }
    if (typeof successCallback !== 'function')
    {
        console.log('PushNotification.getDeviceToken failure: success callback parameter must be a function');
        return;
    }
